...
<head>
    ...
    <main class="">
        <div class="container-fluid text-center">
            ...
            <iframe src="{{ $presentation['presentation_url'] }}" frameborder="0" width="960" height="500" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
        </div>
    </main>
    <!--/Main layout-->
